...
const Chuteiras: React.FC = () => {
  document.title = 'TLIMITED - CHUTEIRAS'
  ...
  useEffect(() => {
    ...
    axios.post('https://leonardocorbi.dev/php/getAllChuteiras.php', getProductsFD)
